...
hooks:
  pre: |
    echo "Initializing javascript-typescript-specialist"
  post: |
    echo "Completed javascript-typescript-specialist execution"
---
...
Task("Ultra-specialized JavaScript and TypeScript expert...", "detailed instructions here", "javascript-typescript-specialist")
```
...
Task("primary task", "...", "javascript-typescript-specialist")
