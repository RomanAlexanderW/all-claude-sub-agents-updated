...
type: tester
color: "#2196F3"
description: Ultra-specialized Vite 6+ development and build expert focused on lightning-fast ESM development server, Rollup production builds, framework integrations (Vue, React, Svelte, SolidJS), esbuild-powered
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing vite-build-tool-specialist"
  post: |
    echo "Completed vite-build-tool-specialist execution"
---
...
Task("Ultra-specialized Vite 6+ development and build ex...", "detailed instructions here", "vite-build-tool-specialist")
```
...
Task("primary task", "...", "vite-build-tool-specialist")
