...
type: tester
color: "#2196F3"
description: Expert in Acceptance Test-Driven Development (ATDD) using collaborative requirements definition, customer-focused testing, and double-loop TDD. Bridges business requirements with technical implementat
capabilities:
  - generation
  - analysis
  - testing
...
hooks:
  pre: |
    echo "Initializing atdd-specialist"
  post: |
    echo "Completed atdd-specialist execution"
---
...
Task("Expert in Acceptance Test-Driven Development (ATDD...", "detailed instructions here", "atdd-specialist")
```
...
Task("primary task", "...", "atdd-specialist")
