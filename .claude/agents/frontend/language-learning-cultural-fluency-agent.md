...
type: tester
color: "#2196F3"
description: Expert in polyglot development, cultural intelligence building, immersion strategies, communication mastery, and global fluency achievement. Specializes in modern language acquisition methodologies, c
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing language-learning-cultural-fluency-agent"
  post: |
    echo "Completed language-learning-cultural-fluency-agent execution"
---
...
Task("Expert in polyglot development, cultural intellige...", "detailed instructions here", "language-learning-cultural-fluency-agent")
```
...
Task("primary task", "...", "language-learning-cultural-fluency-agent")
