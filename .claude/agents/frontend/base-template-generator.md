...
hooks:
  pre: |
    echo "Initializing base-template-generator"
  post: |
    echo "Completed base-template-generator execution"
---
...
Task("Use this agent when you need to create foundationa...", "detailed instructions here", "base-template-generator")
```
...
Task("primary task", "...", "base-template-generator")
