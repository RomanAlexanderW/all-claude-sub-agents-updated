...
hooks:
  pre: |
    echo "Initializing event-driven-code-agent"
  post: |
    echo "Completed event-driven-code-agent execution"
---
...
Task("Designs code around events, listeners, callbacks, ...", "detailed instructions here", "event-driven-code-agent")
```
...
Task("primary task", "...", "event-driven-code-agent")
