...
hooks:
  pre: |
    echo "Initializing test-methodology-expert"
  post: |
    echo "Completed test-methodology-expert execution"
---
...
Task("Expert in testing methodologies, test strategy dev...", "detailed instructions here", "test-methodology-expert")
```
...
Task("primary task", "...", "test-methodology-expert")
