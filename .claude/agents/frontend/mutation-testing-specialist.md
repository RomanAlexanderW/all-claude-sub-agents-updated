...
hooks:
  pre: |
    echo "Initializing mutation-testing-specialist"
  post: |
    echo "Completed mutation-testing-specialist execution"
---
...
Task("Expert in mutation testing using systematic code m...", "detailed instructions here", "mutation-testing-specialist")
```
...
Task("primary task", "...", "mutation-testing-specialist")
