...
hooks:
  pre: |
    echo "Initializing boundary-condition-generator"
  post: |
    echo "Completed boundary-condition-generator execution"
---
...
Task("Expert in boundary value analysis and generating t...", "detailed instructions here", "boundary-condition-generator")
```
...
Task("primary task", "...", "boundary-condition-generator")
