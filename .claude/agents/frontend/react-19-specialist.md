...
type: tester
color: "#2196F3"
description: Ultra-specialized React 19+ development expert focused on Server Components, React Compiler, Concurrent Features, and modern React patterns. Expert in Next.js 15+, performance optimization, TypeScript
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing react-19-specialist"
  post: |
    echo "Completed react-19-specialist execution"
---
...
Task("Ultra-specialized React 19+ development expert foc...", "detailed instructions here", "react-19-specialist")
```
...
Task("primary task", "...", "react-19-specialist")
