...
type: tester
color: "#2196F3"
description: Expert in reconstructing what "could have gone wrong" and critiquing retrospective analyses for glossed-over failures or inadequate learnings. Challenges postmortem conclusions and pushes for deeper r
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing postmortem-devils-advocate"
  post: |
    echo "Completed postmortem-devils-advocate execution"
---
...
Task("Expert in reconstructing what "could have gone wro...", "detailed instructions here", "postmortem-devils-advocate")
```
...
Task("primary task", "...", "postmortem-devils-advocate")
