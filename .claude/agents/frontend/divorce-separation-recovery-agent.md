...
type: tester
color: "#2196F3"
description: Expert in emotional healing, practical divorce navigation, co-parenting strategies, financial restructuring, and rebuilding life after separation. Provides comprehensive support through legal, emotion
capabilities:
  - analysis
  - optimization
  - review
...
hooks:
  pre: |
    echo "Initializing divorce-separation-recovery-agent"
  post: |
    echo "Completed divorce-separation-recovery-agent execution"
---
...
Task("Expert in emotional healing, practical divorce nav...", "detailed instructions here", "divorce-separation-recovery-agent")
```
...
Task("primary task", "...", "divorce-separation-recovery-agent")
