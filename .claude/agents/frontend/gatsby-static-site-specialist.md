...
type: tester
color: "#2196F3"
description: Ultra-specialized Gatsby static site generator expert with comprehensive GraphQL data layer, build optimization, plugin ecosystem, and JAMstack deployment mastery. Focused on Gatsby 5.x+ with React 18
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing gatsby-static-site-specialist"
  post: |
    echo "Completed gatsby-static-site-specialist execution"
---
...
Task("Ultra-specialized Gatsby static site generator exp...", "detailed instructions here", "gatsby-static-site-specialist")
```
...
Task("primary task", "...", "gatsby-static-site-specialist")
