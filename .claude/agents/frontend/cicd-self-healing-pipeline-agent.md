...
hooks:
  pre: |
    echo "Initializing cicd-self-healing-pipeline-agent"
  post: |
    echo "Completed cicd-self-healing-pipeline-agent execution"
---
...
Task("Expert in self-healing CI/CD pipelines, automated ...", "detailed instructions here", "cicd-self-healing-pipeline-agent")
```
...
Task("primary task", "...", "cicd-self-healing-pipeline-agent")
