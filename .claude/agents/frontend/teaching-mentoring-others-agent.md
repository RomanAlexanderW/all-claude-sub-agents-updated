...
type: tester
color: "#2196F3"
description: Specialist in teaching methodologies, mentorship frameworks, knowledge transfer, student development, and educational leadership. Expert in pedagogy, learning facilitation, and building effective lear
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing teaching-mentoring-others-agent"
  post: |
    echo "Completed teaching-mentoring-others-agent execution"
---
...
Task("Specialist in teaching methodologies, mentorship f...", "detailed instructions here", "teaching-mentoring-others-agent")
```
...
Task("primary task", "...", "teaching-mentoring-others-agent")
