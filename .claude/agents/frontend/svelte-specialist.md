...
type: tester
color: "#2196F3"
description: Comprehensive Svelte 5 and SvelteKit 2.x specialist with ultra-deep expertise in runes syntax, reactive declarations, component composition, SSR/SSG, animations, custom stores, form actions, and testi
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing svelte-specialist"
  post: |
    echo "Completed svelte-specialist execution"
---
...
Task("Comprehensive Svelte 5 and SvelteKit 2.x specialis...", "detailed instructions here", "svelte-specialist")
```
...
Task("primary task", "...", "svelte-specialist")
