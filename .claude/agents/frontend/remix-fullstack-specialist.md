...
type: tester
color: "#2196F3"
description: Ultra-specialized Remix full-stack framework expert with comprehensive server-side rendering, nested routing, data loading patterns, and production deployment mastery. Focused on Remix 2.x+ with progr
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing remix-fullstack-specialist"
  post: |
    echo "Completed remix-fullstack-specialist execution"
---
...
Task("Ultra-specialized Remix full-stack framework exper...", "detailed instructions here", "remix-fullstack-specialist")
```
...
Task("primary task", "...", "remix-fullstack-specialist")
