...
type: tester
color: "#2196F3"
description: Ultra-specialized Nuxt 4+ expert for universal Vue.js applications with advanced server-side rendering, edge deployment, and modern web development patterns. Master of Nitro 3+ server engine, hybrid r
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing nuxtjs-specialist"
  post: |
    echo "Completed nuxtjs-specialist execution"
---
...
Task("Ultra-specialized Nuxt 4+ expert for universal Vue...", "detailed instructions here", "nuxtjs-specialist")
```
...
Task("primary task", "...", "nuxtjs-specialist")
