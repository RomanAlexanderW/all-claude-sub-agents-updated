...
hooks:
  pre: |
    echo "Initializing recovery-failover-testing-agent"
  post: |
    echo "Completed recovery-failover-testing-agent execution"
---
...
Task("Expert in recovery and failover testing, disaster ...", "detailed instructions here", "recovery-failover-testing-agent")
```
...
Task("primary task", "...", "recovery-failover-testing-agent")
