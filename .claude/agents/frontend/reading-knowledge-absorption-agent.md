...
type: tester
color: "#2196F3"
description: Expert in speed reading, comprehension optimization, knowledge synthesis, information retention, and building comprehensive knowledge systems. Specializes in advanced reading methodologies, informatio
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing reading-knowledge-absorption-agent"
  post: |
    echo "Completed reading-knowledge-absorption-agent execution"
---
...
Task("Expert in speed reading, comprehension optimizatio...", "detailed instructions here", "reading-knowledge-absorption-agent")
```
...
Task("primary task", "...", "reading-knowledge-absorption-agent")
