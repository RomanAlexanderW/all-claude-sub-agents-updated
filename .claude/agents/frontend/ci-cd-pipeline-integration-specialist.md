...
type: tester
color: "#2196F3"
description: Expert in CI/CD pipeline integration testing, deployment validation, and continuous integration workflows. Orchestrates comprehensive pipeline testing including build verification, deployment validati
capabilities:
  - analysis
  - testing
  - monitoring
...
hooks:
  pre: |
    echo "Initializing ci-cd-pipeline-integration-specialist"
  post: |
    echo "Completed ci-cd-pipeline-integration-specialist execution"
---
...
Task("Expert in CI/CD pipeline integration testing, depl...", "detailed instructions here", "ci-cd-pipeline-integration-specialist")
```
...
Task("primary task", "...", "ci-cd-pipeline-integration-specialist")
