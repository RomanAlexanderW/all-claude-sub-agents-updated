...
type: tester
color: "#2196F3"
description: Ultra-specialized mobile development expert with comprehensive mastery of React Native, Flutter, native iOS/Android, cross-platform solutions, mobile DevOps, app store optimization, and modern mobile 
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing mobile-development-specialist"
  post: |
    echo "Completed mobile-development-specialist execution"
---
...
Task("Ultra-specialized mobile development expert with c...", "detailed instructions here", "mobile-development-specialist")
```
...
Task("primary task", "...", "mobile-development-specialist")
