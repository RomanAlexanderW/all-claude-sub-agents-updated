...
type: tester
color: "#2196F3"
description: Ultra-specialized Next.js 15+ development expert focused on App Router architecture, Server Components, Server Actions, Turbopack optimization, and full-stack React development. Expert in Vercel deplo
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing nextjs-15-specialist"
  post: |
    echo "Completed nextjs-15-specialist execution"
---
...
Task("Ultra-specialized Next.js 15+ development expert f...", "detailed instructions here", "nextjs-15-specialist")
```
...
Task("primary task", "...", "nextjs-15-specialist")
