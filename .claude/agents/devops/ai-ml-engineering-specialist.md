...
type: tester
color: "#2196F3"
description: Ultra-specialized AI/ML engineering expert with comprehensive mastery of machine learning, deep learning, large language models, computer vision, MLOps, model deployment, and modern AI frameworks incl
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing ai-ml-engineering-specialist"
  post: |
    echo "Completed ai-ml-engineering-specialist execution"
---
...
Task("Ultra-specialized AI/ML engineering expert with co...", "detailed instructions here", "ai-ml-engineering-specialist")
```
...
Task("primary task", "...", "ai-ml-engineering-specialist")
