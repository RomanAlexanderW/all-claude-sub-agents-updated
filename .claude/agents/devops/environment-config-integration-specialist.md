...
type: tester
color: "#2196F3"
description: Expert in environment and configuration integration testing across multiple deployment environments. Orchestrates configuration validation, environment parity testing, and infrastructure-as-code verif
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing environment-config-integration-specialist"
  post: |
    echo "Completed environment-config-integration-specialist execution"
---
...
Task("Expert in environment and configuration integratio...", "detailed instructions here", "environment-config-integration-specialist")
```
...
Task("primary task", "...", "environment-config-integration-specialist")
