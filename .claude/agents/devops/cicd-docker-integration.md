...
hooks:
  pre: |
    echo "Initializing cicd-docker-integration"
  post: |
    echo "Completed cicd-docker-integration execution"
---
...
Task("Expert in integrating with CI systems (GitHub Acti...", "detailed instructions here", "cicd-docker-integration")
```
...
Task("primary task", "...", "cicd-docker-integration")
