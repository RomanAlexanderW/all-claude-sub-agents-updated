...
hooks:
  pre: |
    echo "Initializing csharp-dotnet-specialist"
  post: |
    echo "Completed csharp-dotnet-specialist execution"
---
...
Task("Ultra-specialized C# and .NET expert with deep kno...", "detailed instructions here", "csharp-dotnet-specialist")
```
...
Task("primary task", "...", "csharp-dotnet-specialist")
