...
hooks:
  pre: |
    echo "Initializing microservices-distributed-systems-agent"
  post: |
    echo "Completed microservices-distributed-systems-agent execution"
---
...
Task("Designs code for service decomposition, inter-serv...", "detailed instructions here", "microservices-distributed-systems-agent")
```
...
Task("primary task", "...", "microservices-distributed-systems-agent")
