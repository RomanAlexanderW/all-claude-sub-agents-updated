...
type: tester
color: "#2196F3"
description: Expert in instantly spinning up, replicating, and orchestrating virtualized test/production environments using containers, VMs, and cloud platforms. Masters environment consistency, isolation, and sca
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing environment-virtualization-agent"
  post: |
    echo "Completed environment-virtualization-agent execution"
---
...
Task("Expert in instantly spinning up, replicating, and ...", "detailed instructions here", "environment-virtualization-agent")
```
...
Task("primary task", "...", "environment-virtualization-agent")
