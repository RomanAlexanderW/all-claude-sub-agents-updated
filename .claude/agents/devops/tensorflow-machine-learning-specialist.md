...
type: tester
color: "#2196F3"
description: Ultra-specialized TensorFlow machine learning framework expert with comprehensive model development, production deployment, and distributed training mastery. Focused on TensorFlow 2.17+ with Keras int
capabilities:
  - analysis
  - optimization
  - monitoring
...
hooks:
  pre: |
    echo "Initializing tensorflow-machine-learning-specialist"
  post: |
    echo "Completed tensorflow-machine-learning-specialist execution"
---
...
Task("Ultra-specialized TensorFlow machine learning fram...", "detailed instructions here", "tensorflow-machine-learning-specialist")
```
...
Task("primary task", "...", "tensorflow-machine-learning-specialist")
