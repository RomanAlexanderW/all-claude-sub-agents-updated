...
hooks:
  pre: |
    echo "Initializing edd-specialist"
  post: |
    echo "Completed edd-specialist execution"
---
...
Task("Expert in Example-Driven Development (EDD) using c...", "detailed instructions here", "edd-specialist")
```
...
Task("primary task", "...", "edd-specialist")
