...
type: tester
color: "#2196F3"
description: Ultra-specialized Flutter and Dart expert for cross-platform mobile, web, and desktop applications. Master of modern Flutter 3.x+, Dart 3.x, state management, animations, and platform-specific integra
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing flutter-specialist-agent"
  post: |
    echo "Completed flutter-specialist-agent execution"
---
...
Task("Ultra-specialized Flutter and Dart expert for cros...", "detailed instructions here", "flutter-specialist-agent")
```
...
Task("primary task", "...", "flutter-specialist-agent")
