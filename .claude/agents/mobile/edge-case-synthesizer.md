...
hooks:
  pre: |
    echo "Initializing edge-case-synthesizer"
  post: |
    echo "Completed edge-case-synthesizer execution"
---
...
Task("Expert in generating comprehensive edge cases thro...", "detailed instructions here", "edge-case-synthesizer")
```
...
Task("primary task", "...", "edge-case-synthesizer")
