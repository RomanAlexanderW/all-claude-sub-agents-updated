...
type: tester
color: "#2196F3"
description: Expert in performance and load testing during integration phases. Orchestrates comprehensive performance validation, load testing scenarios, and scalability assessment across integrated systems with a
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing performance-load-integration-specialist"
  post: |
    echo "Completed performance-load-integration-specialist execution"
---
...
Task("Expert in performance and load testing during inte...", "detailed instructions here", "performance-load-integration-specialist")
```
...
Task("primary task", "...", "performance-load-integration-specialist")
