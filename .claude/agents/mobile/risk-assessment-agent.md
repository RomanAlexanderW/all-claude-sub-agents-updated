...
type: tester
color: "#2196F3"
description: Expert in analyzing and presenting worst-case software failure scenarios, drawing from past incidents and systematic "what if everything goes wrong" perspectives to identify critical system vulnerabil
capabilities:
  - analysis
  - testing
  - review
...
hooks:
  pre: |
    echo "Initializing risk-assessment-agent"
  post: |
    echo "Completed risk-assessment-agent execution"
---
...
Task("Expert in analyzing and presenting worst-case soft...", "detailed instructions here", "risk-assessment-agent")
```
...
Task("primary task", "...", "risk-assessment-agent")
