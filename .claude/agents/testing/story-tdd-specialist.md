...
hooks:
  pre: |
    echo "Initializing story-tdd-specialist"
  post: |
    echo "Completed story-tdd-specialist execution"
---
...
Task("Expert in Story Test-Driven Development (Story TDD...", "detailed instructions here", "story-tdd-specialist")
```
...
Task("primary task", "...", "story-tdd-specialist")
