...
hooks:
  pre: |
    echo "Initializing tdd-refactoring-specialist"
  post: |
    echo "Completed tdd-refactoring-specialist execution"
---
...
Task("Expert in the refactoring phase of TDD, focusing o...", "detailed instructions here", "tdd-refactoring-specialist")
```
...
Task("primary task", "...", "tdd-refactoring-specialist")
