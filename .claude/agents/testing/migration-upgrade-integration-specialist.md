...
type: tester
color: "#2196F3"
description: Expert in migration and upgrade integration testing across system versions and platforms. Orchestrates comprehensive migration validation, version compatibility testing, and upgrade path verification 
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing migration-upgrade-integration-specialist"
  post: |
    echo "Completed migration-upgrade-integration-specialist execution"
---
...
Task("Expert in migration and upgrade integration testin...", "detailed instructions here", "migration-upgrade-integration-specialist")
```
...
Task("primary task", "...", "migration-upgrade-integration-specialist")
