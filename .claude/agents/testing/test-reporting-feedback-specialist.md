...
type: tester
color: "#2196F3"
description: Expert in comprehensive test reporting, analytics, and feedback systems. Orchestrates intelligent test result analysis, automated insights generation, and stakeholder communication with advanced repor
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing test-reporting-feedback-specialist"
  post: |
    echo "Completed test-reporting-feedback-specialist execution"
---
...
Task("Expert in comprehensive test reporting, analytics,...", "detailed instructions here", "test-reporting-feedback-specialist")
```
...
Task("primary task", "...", "test-reporting-feedback-specialist")
