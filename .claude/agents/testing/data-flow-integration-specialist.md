...
type: tester
color: "#2196F3"
description: Expert in validating data flow integrity, transformation accuracy, and data consistency across system boundaries. Orchestrates comprehensive data validation, lineage tracking, and cross-system data sy
capabilities:
  - generation
  - analysis
  - testing
...
hooks:
  pre: |
    echo "Initializing data-flow-integration-specialist"
  post: |
    echo "Completed data-flow-integration-specialist execution"
---
...
Task("Expert in validating data flow integrity, transfor...", "detailed instructions here", "data-flow-integration-specialist")
```
...
Task("primary task", "...", "data-flow-integration-specialist")
