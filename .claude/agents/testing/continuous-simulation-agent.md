...
hooks:
  pre: |
    echo "Initializing continuous-simulation-agent"
  post: |
    echo "Completed continuous-simulation-agent execution"
---
...
Task("Expert in modeling continuously changing systems u...", "detailed instructions here", "continuous-simulation-agent")
```
...
Task("primary task", "...", "continuous-simulation-agent")
