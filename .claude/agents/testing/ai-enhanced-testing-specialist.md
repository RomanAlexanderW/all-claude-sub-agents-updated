...
hooks:
  pre: |
    echo "Initializing ai-enhanced-testing-specialist"
  post: |
    echo "Completed ai-enhanced-testing-specialist execution"
---
...
Task("Expert in AI-enhanced testing, machine learning fo...", "detailed instructions here", "ai-enhanced-testing-specialist")
```
...
Task("primary task", "...", "ai-enhanced-testing-specialist")
