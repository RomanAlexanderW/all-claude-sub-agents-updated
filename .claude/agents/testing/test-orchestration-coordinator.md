...
hooks:
  pre: |
    echo "Initializing test-orchestration-coordinator"
  post: |
    echo "Completed test-orchestration-coordinator execution"
---
...
Task("Expert in test orchestration, test execution coord...", "detailed instructions here", "test-orchestration-coordinator")
```
...
Task("primary task", "...", "test-orchestration-coordinator")
