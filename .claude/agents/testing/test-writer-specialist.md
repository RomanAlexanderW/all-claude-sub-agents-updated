...
hooks:
  pre: |
    echo "Initializing test-writer-specialist"
  post: |
    echo "Completed test-writer-specialist execution"
---
...
Task("Expert in writing comprehensive, maintainable test...", "detailed instructions here", "test-writer-specialist")
```
...
Task("primary task", "...", "test-writer-specialist")
