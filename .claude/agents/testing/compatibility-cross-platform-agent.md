...
hooks:
  pre: |
    echo "Initializing compatibility-cross-platform-agent"
  post: |
    echo "Completed compatibility-cross-platform-agent execution"
---
...
Task("Expert in compatibility and cross-platform testing...", "detailed instructions here", "compatibility-cross-platform-agent")
```
...
Task("primary task", "...", "compatibility-cross-platform-agent")
