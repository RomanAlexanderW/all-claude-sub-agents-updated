...
type: tester
color: "#2196F3"
description: Expert in mock and stub-based integration testing for early-stage validation. Simulates external dependencies with controlled responses to isolate system components and validate internal logic before 
capabilities:
  - analysis
  - testing
priority: high
hooks:
  pre: |
    echo "Initializing mock-stub-integration-specialist"
  post: |
    echo "Completed mock-stub-integration-specialist execution"
---
...
Task("Expert in mock and stub-based integration testing ...", "detailed instructions here", "mock-stub-integration-specialist")
```
...
Task("primary task", "...", "mock-stub-integration-specialist")
