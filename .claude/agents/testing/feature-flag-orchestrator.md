...
hooks:
  pre: |
    echo "Initializing feature-flag-orchestrator"
  post: |
    echo "Completed feature-flag-orchestrator execution"
---
...
Task("Expert in feature flag management, progressive rol...", "detailed instructions here", "feature-flag-orchestrator")
```
...
Task("primary task", "...", "feature-flag-orchestrator")
