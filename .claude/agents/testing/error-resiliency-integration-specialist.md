...
type: tester
color: "#2196F3"
description: Expert in testing system resilience, fault tolerance, and error handling across integration boundaries. Implements chaos engineering, failure injection, and recovery validation to ensure systems grace
capabilities:
  - analysis
  - testing
  - monitoring
...
hooks:
  pre: |
    echo "Initializing error-resiliency-integration-specialist"
  post: |
    echo "Completed error-resiliency-integration-specialist execution"
---
...
Task("Expert in testing system resilience, fault toleran...", "detailed instructions here", "error-resiliency-integration-specialist")
```
...
Task("primary task", "...", "error-resiliency-integration-specialist")
