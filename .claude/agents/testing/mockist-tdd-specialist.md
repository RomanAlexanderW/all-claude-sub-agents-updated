...
hooks:
  pre: |
    echo "Initializing mockist-tdd-specialist"
  post: |
    echo "Completed mockist-tdd-specialist execution"
---
...
Task("Expert in Mockist/London School TDD using outside-...", "detailed instructions here", "mockist-tdd-specialist")
```
...
Task("primary task", "...", "mockist-tdd-specialist")
