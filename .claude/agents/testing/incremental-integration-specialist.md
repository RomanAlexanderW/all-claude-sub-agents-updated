...
type: tester
color: "#2196F3"
description: Expert in incremental integration testing strategies including top-down, bottom-up, and sandwich approaches. Orchestrates systematic module integration with strategic stub/driver usage for complex sys
capabilities:
  - generation
  - analysis
  - testing
...
hooks:
  pre: |
    echo "Initializing incremental-integration-specialist"
  post: |
    echo "Completed incremental-integration-specialist execution"
---
...
Task("Expert in incremental integration testing strategi...", "detailed instructions here", "incremental-integration-specialist")
```
...
Task("primary task", "...", "incremental-integration-specialist")
