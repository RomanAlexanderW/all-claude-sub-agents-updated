...
hooks:
  pre: |
    echo "Initializing implementation-specialist"
  post: |
    echo "Completed implementation-specialist execution"
---
...
Task("Expert in implementing code to make failing tests ...", "detailed instructions here", "implementation-specialist")
```
...
Task("primary task", "...", "implementation-specialist")
