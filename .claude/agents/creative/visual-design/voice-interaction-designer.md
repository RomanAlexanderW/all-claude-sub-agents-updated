...
hooks:
  pre: |
    echo "Initializing voice-interaction-designer"
  post: |
    echo "Completed voice-interaction-designer execution"
---
...
Task("Expert in voice user interfaces, conversational de...", "detailed instructions here", "voice-interaction-designer")
```
...
Task("primary task", "...", "voice-interaction-designer")
