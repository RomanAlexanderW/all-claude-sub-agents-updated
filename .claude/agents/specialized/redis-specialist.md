...
hooks:
  pre: |
    echo "Initializing redis-specialist"
  post: |
    echo "Completed redis-specialist execution"
---
...
Task("Expert in Redis 7.x+ data structures, clustering, ...", "detailed instructions here", "redis-specialist")
```
...
Task("primary task", "...", "redis-specialist")
