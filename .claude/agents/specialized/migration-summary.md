...
type: tester
color: "#2196F3"
description: This document provides a complete migration plan for converting the existing command-based system (.claude/commands/) to the new intelligent agent-based system (.claude/agents/). The migration preserv
capabilities:
  - analysis
  - optimization
  - review
...
hooks:
  pre: |
    echo "Initializing migration-summary"
  post: |
    echo "Completed migration-summary execution"
---
...
Task("This document provides a complete migration plan f...", "detailed instructions here", "migration-summary")
```
...
Task("primary task", "...", "migration-summary")
