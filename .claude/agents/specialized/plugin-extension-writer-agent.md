...
hooks:
  pre: |
    echo "Initializing plugin-extension-writer-agent"
  post: |
    echo "Completed plugin-extension-writer-agent execution"
---
...
Task("Creates plug-ins, browser extensions, IDE integrat...", "detailed instructions here", "plugin-extension-writer-agent")
```
...
Task("primary task", "...", "plugin-extension-writer-agent")
