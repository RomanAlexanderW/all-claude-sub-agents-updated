...
hooks:
  pre: |
    echo "Initializing market-user-research"
  post: |
    echo "Completed market-user-research execution"
---
...
Task("Comprehensive business and user research specialis...", "detailed instructions here", "market-user-research")
```
...
Task("primary task", "...", "market-user-research")
