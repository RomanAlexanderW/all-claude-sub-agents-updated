...
type: tester
color: "#2196F3"
description: name: life-transition-navigation-agent
capabilities:
  - review
  - planning
  - monitoring
...
hooks:
  pre: |
    echo "Initializing life-transition-navigation-agent"
  post: |
    echo "Completed life-transition-navigation-agent execution"
---
...
Task("name: life-transition-navigation-agent...", "detailed instructions here", "life-transition-navigation-agent")
```
...
Task("primary task", "...", "life-transition-navigation-agent")
