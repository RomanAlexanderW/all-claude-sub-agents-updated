...
type: tester
color: "#2196F3"
description: Expert in Behavior-Driven Development (BDD) using Gherkin syntax, specification by example, and collaborative behavior definition. Bridges communication between technical and non-technical stakeholder
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing bdd-specialist"
  post: |
    echo "Completed bdd-specialist execution"
---
...
Task("Expert in Behavior-Driven Development (BDD) using ...", "detailed instructions here", "bdd-specialist")
```
...
Task("primary task", "...", "bdd-specialist")
