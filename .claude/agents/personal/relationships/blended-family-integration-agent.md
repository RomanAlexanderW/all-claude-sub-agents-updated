...
hooks:
  pre: |
    echo "Initializing blended-family-integration-agent"
  post: |
    echo "Completed blended-family-integration-agent execution"
---
...
Task("Expert in stepparenting, blended family dynamics, ...", "detailed instructions here", "blended-family-integration-agent")
```
...
Task("primary task", "...", "blended-family-integration-agent")
