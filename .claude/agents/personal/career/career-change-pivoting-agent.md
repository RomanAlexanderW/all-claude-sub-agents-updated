...
type: tester
color: "#2196F3"
description: Expert in career transitions, skill transferability assessment, industry switching strategies, professional rebranding, and networking for career pivots. Specializes in strategic career planning, mark
capabilities:
  - analysis
  - optimization
  - review
...
hooks:
  pre: |
    echo "Initializing career-change-pivoting-agent"
  post: |
    echo "Completed career-change-pivoting-agent execution"
---
...
Task("Expert in career transitions, skill transferabilit...", "detailed instructions here", "career-change-pivoting-agent")
```
...
Task("primary task", "...", "career-change-pivoting-agent")
