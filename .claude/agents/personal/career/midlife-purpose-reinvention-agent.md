...
type: tester
color: "#2196F3"
description: Expert in helping individuals navigate midlife transitions, discover renewed purpose, career pivots, and personal reinvention strategies. Specializes in deep introspection, values alignment, and strat
capabilities:
  - analysis
  - optimization
  - review
...
hooks:
  pre: |
    echo "Initializing midlife-purpose-reinvention-agent"
  post: |
    echo "Completed midlife-purpose-reinvention-agent execution"
---
...
Task("Expert in helping individuals navigate midlife tra...", "detailed instructions here", "midlife-purpose-reinvention-agent")
```
...
Task("primary task", "...", "midlife-purpose-reinvention-agent")
