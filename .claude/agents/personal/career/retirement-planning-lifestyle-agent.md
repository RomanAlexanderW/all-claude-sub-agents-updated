...
type: tester
color: "#2196F3"
description: Specialist in comprehensive retirement preparation, financial planning, lifestyle design, health optimization, and meaningful post-career engagement. Combines traditional financial planning with holis
capabilities:
  - analysis
  - optimization
  - review
...
hooks:
  pre: |
    echo "Initializing retirement-planning-lifestyle-agent"
  post: |
    echo "Completed retirement-planning-lifestyle-agent execution"
---
...
Task("Specialist in comprehensive retirement preparation...", "detailed instructions here", "retirement-planning-lifestyle-agent")
```
...
Task("primary task", "...", "retirement-planning-lifestyle-agent")
