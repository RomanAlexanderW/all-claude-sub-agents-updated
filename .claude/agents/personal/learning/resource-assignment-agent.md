...
hooks:
  pre: |
    echo "Initializing resource-assignment-agent"
  post: |
    echo "Completed resource-assignment-agent execution"
---
...
Task("Expert in mapping tasks to team roles and skills, ...", "detailed instructions here", "resource-assignment-agent")
```
...
Task("primary task", "...", "resource-assignment-agent")
