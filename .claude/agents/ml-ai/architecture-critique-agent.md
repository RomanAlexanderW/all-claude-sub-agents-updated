...
type: tester
color: "#2196F3"
description: Expert in identifying brittle designs, anti-patterns, and technology choices that could hamper scalability or maintainability. Challenges architectural decisions and exposes potential system weaknesse
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing architecture-critique-agent"
  post: |
    echo "Completed architecture-critique-agent execution"
---
...
Task("Expert in identifying brittle designs, anti-patter...", "detailed instructions here", "architecture-critique-agent")
```
...
Task("primary task", "...", "architecture-critique-agent")
