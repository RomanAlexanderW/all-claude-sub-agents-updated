...
hooks:
  pre: |
    echo "Initializing ruby-rails-specialist"
  post: |
    echo "Completed ruby-rails-specialist execution"
---
...
Task("Ultra-specialized Ruby and Rails expert with deep ...", "detailed instructions here", "ruby-rails-specialist")
```
...
Task("primary task", "...", "ruby-rails-specialist")
