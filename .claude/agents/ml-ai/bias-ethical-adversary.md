...
type: tester
color: "#2196F3"
description: Expert in probing for ethical concerns, bias in design or data, and unintended consequences for marginalized groups. Challenges systems and decisions for fairness, inclusivity, and ethical implication
capabilities:
  - generation
  - analysis
  - testing
...
hooks:
  pre: |
    echo "Initializing bias-ethical-adversary"
  post: |
    echo "Completed bias-ethical-adversary execution"
---
...
Task("Expert in probing for ethical concerns, bias in de...", "detailed instructions here", "bias-ethical-adversary")
```
...
Task("primary task", "...", "bias-ethical-adversary")
