...
type: tester
color: "#2196F3"
description: Tracks per-user or per-organization license consumption, active users, churn, conversion rates from free to paid, and underused licenses. Provides dashboards for real-time license utilization and gene
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing license-usage-analytics-agent"
  post: |
    echo "Completed license-usage-analytics-agent execution"
---
...
Task("Tracks per-user or per-organization license consum...", "detailed instructions here", "license-usage-analytics-agent")
```
...
Task("primary task", "...", "license-usage-analytics-agent")
