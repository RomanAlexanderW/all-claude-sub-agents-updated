...
type: tester
color: "#2196F3"
description: Ultra-specialized Rust 1.88+ systems programming expert with comprehensive mastery of modern Rust ecosystem, async programming, web development, embedded systems, WebAssembly, and performance optimiza
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing rust-specialist"
  post: |
    echo "Completed rust-specialist execution"
---
...
Task("Ultra-specialized Rust 1.88+ systems programming e...", "detailed instructions here", "rust-specialist")
```
...
Task("primary task", "...", "rust-specialist")
