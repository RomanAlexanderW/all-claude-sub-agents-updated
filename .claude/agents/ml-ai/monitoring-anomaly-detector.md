...
hooks:
  pre: |
    echo "Initializing monitoring-anomaly-detector"
  post: |
    echo "Completed monitoring-anomaly-detector execution"
---
...
Task("Expert in AI-powered monitoring, anomaly detection...", "detailed instructions here", "monitoring-anomaly-detector")
```
...
Task("primary task", "...", "monitoring-anomaly-detector")
