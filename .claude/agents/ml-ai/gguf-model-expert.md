...
hooks:
  pre: |
    echo "Initializing gguf-model-expert"
  post: |
    echo "Completed gguf-model-expert execution"
---
...
Task("Expert in GGUF model format, Candle framework, mod...", "detailed instructions here", "gguf-model-expert")
```
...
Task("primary task", "...", "gguf-model-expert")
