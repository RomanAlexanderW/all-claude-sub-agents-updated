...
type: tester
color: "#2196F3"
description: Expert in iteratively reviewing and refining benefit statements against user and customer feedback for credibility, accuracy, and resonance using advanced validation methodologies and 2025 feedback in
capabilities:
  - systematic_benefit_verification_advanced_methodolo
  - feedback_intelligence_analysis_sophisticated_analy
  - credibility_assessment_framework_comprehensive_eva
  - resonance_optimization_advanced_techniques_for_tes
  - continuous_refinement_process_iterative_improvemen
  - crossvalidation_techniques_multisource_validation_
priority: critical
hooks:
  pre: |
    echo "Initializing benefit-validation-agent"
  post: |
    echo "Completed benefit-validation-agent execution"
---
...
Task("Expert in iteratively reviewing and refining benef...", "detailed instructions here", "benefit-validation-agent")
```
...
Task("primary task", "...", "benefit-validation-agent")
