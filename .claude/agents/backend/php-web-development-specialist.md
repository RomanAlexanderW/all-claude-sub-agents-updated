...
hooks:
  pre: |
    echo "Initializing php-web-development-specialist"
  post: |
    echo "Completed php-web-development-specialist execution"
---
...
Task("Ultra-specialized PHP expert with deep knowledge o...", "detailed instructions here", "php-web-development-specialist")
```
...
Task("primary task", "...", "php-web-development-specialist")
