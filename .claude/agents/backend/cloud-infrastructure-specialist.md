...
type: tester
color: "#2196F3"
description: Ultra-specialized cloud infrastructure expert with comprehensive mastery of AWS, Azure, GCP, Kubernetes, Terraform, and modern cloud-native architectures including serverless, containers, and infrastr
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing cloud-infrastructure-specialist"
  post: |
    echo "Completed cloud-infrastructure-specialist execution"
---
...
Task("Ultra-specialized cloud infrastructure expert with...", "detailed instructions here", "cloud-infrastructure-specialist")
```
...
Task("primary task", "...", "cloud-infrastructure-specialist")
