...
type: tester
color: "#2196F3"
description: Expert in modeling event-driven systems through discrete event simulation for testing microservices, workflows, and business processes. Masters digital twin integration and chaos engineering validatio
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing discrete-event-simulation-agent"
  post: |
    echo "Completed discrete-event-simulation-agent execution"
---
...
Task("Expert in modeling event-driven systems through di...", "detailed instructions here", "discrete-event-simulation-agent")
```
...
Task("primary task", "...", "discrete-event-simulation-agent")
