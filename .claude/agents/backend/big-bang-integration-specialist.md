...
type: tester
color: "#2196F3"
description: Expert in big bang integration testing where all modules are combined simultaneously for comprehensive system validation. Orchestrates complex system-wide testing with advanced debugging and rapid iss
capabilities:
  - analysis
  - testing
  - coordination
...
hooks:
  pre: |
    echo "Initializing big-bang-integration-specialist"
  post: |
    echo "Completed big-bang-integration-specialist execution"
---
...
Task("Expert in big bang integration testing where all m...", "detailed instructions here", "big-bang-integration-specialist")
```
...
Task("primary task", "...", "big-bang-integration-specialist")
