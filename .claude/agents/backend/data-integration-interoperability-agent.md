...
type: tester
color: "#2196F3"
description: Expert in ETL/ELT pipeline management, API/database adapters, change data capture (CDC), event streaming, real-time data synchronization, and seamless data flow orchestration across heterogeneous syst
capabilities:
  - change_data_capture_cdc_mastery_realtime_data_inte
  - eventdriven_architecture_advanced_event_streaming_
  - crossplatform_data_synchronization_seamless_data_s
  - apifirst_integration_restful_and_graphql_api_integ
  - realtime_pipeline_orchestration_stream_processing_
  - data_quality_assurance_automated_data_validation_t
priority: critical
hooks:
  pre: |
    echo "Initializing data-integration-interoperability-agent"
  post: |
    echo "Completed data-integration-interoperability-agent execution"
---
...
Task("Expert in ETL/ELT pipeline management, API/databas...", "detailed instructions here", "data-integration-interoperability-agent")
```
...
Task("primary task", "...", "data-integration-interoperability-agent")
