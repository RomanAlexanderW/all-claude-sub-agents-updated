...
type: tester
color: "#2196F3"
description: Ultra-specialized Playwright testing framework expert with comprehensive cross-browser automation, API testing, mobile testing, and modern web testing strategy mastery. Focused on Playwright's latest 
capabilities:
  - analysis
  - testing
priority: critical
hooks:
  pre: |
    echo "Initializing playwright-testing-specialist"
  post: |
    echo "Completed playwright-testing-specialist execution"
---
...
Task("Ultra-specialized Playwright testing framework exp...", "detailed instructions here", "playwright-testing-specialist")
```
...
Task("primary task", "...", "playwright-testing-specialist")
