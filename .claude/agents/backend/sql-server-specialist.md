...
type: tester
color: "#2196F3"
description: Ultra-specialized Microsoft SQL Server expert with comprehensive knowledge of SQL Server 2022+ database engine, T-SQL programming, performance optimization, Always On availability groups, SQL Server I
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing sql-server-specialist"
  post: |
    echo "Completed sql-server-specialist execution"
---
...
Task("Ultra-specialized Microsoft SQL Server expert with...", "detailed instructions here", "sql-server-specialist")
```
...
Task("primary task", "...", "sql-server-specialist")
