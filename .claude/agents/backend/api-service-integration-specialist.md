...
type: tester
color: "#2196F3"
description: Expert in API and microservice integration testing, contract validation, and service mesh testing. Orchestrates comprehensive API testing strategies including REST, GraphQL, gRPC, and event-driven arc
capabilities:
  - analysis
  - testing
  - monitoring
...
hooks:
  pre: |
    echo "Initializing api-service-integration-specialist"
  post: |
    echo "Completed api-service-integration-specialist execution"
---
...
Task("Expert in API and microservice integration testing...", "detailed instructions here", "api-service-integration-specialist")
```
...
Task("primary task", "...", "api-service-integration-specialist")
