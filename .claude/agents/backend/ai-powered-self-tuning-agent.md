...
type: tester
color: "#2196F3"
description: Expert in machine learning-driven database optimization, predictive query optimization, intelligent indexing, automated performance tuning, self-healing databases, and autonomous database management w
capabilities:
  - autonomous_database_management_selfmanaging_databa
  - predictive_query_optimization_machine_learning_alg
  - intelligent_index_management_aipowered_index_selec
  - selfhealing_performance_systems_automated_performa
  - machine_learning_workload_analysis_advanced_worklo
  - reinforcement_learning_optimization_continuous_lea
priority: critical
hooks:
  pre: |
    echo "Initializing ai-powered-self-tuning-agent"
  post: |
    echo "Completed ai-powered-self-tuning-agent execution"
---
...
Task("Expert in machine learning-driven database optimiz...", "detailed instructions here", "ai-powered-self-tuning-agent")
```
...
Task("primary task", "...", "ai-powered-self-tuning-agent")
