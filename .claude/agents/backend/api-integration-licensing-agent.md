...
type: tester
color: "#2196F3"
description: Facilitates external API-based license verification/integration for third-party platforms (marketplaces, channel partners, etc.). Expert in API design, webhook systems, and cross-platform license vali
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing api-integration-licensing-agent"
  post: |
    echo "Completed api-integration-licensing-agent execution"
---
...
Task("Facilitates external API-based license verificatio...", "detailed instructions here", "api-integration-licensing-agent")
```
...
Task("primary task", "...", "api-integration-licensing-agent")
