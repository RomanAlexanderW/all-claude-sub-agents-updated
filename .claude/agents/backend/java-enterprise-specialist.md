...
hooks:
  pre: |
    echo "Initializing java-enterprise-specialist"
  post: |
    echo "Completed java-enterprise-specialist execution"
---
...
Task("Ultra-specialized Java expert with deep knowledge ...", "detailed instructions here", "java-enterprise-specialist")
```
...
Task("primary task", "...", "java-enterprise-specialist")
