...
type: tester
color: "#2196F3"
description: Core SQLite Engine Mastery (3.45+):
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing sqlite-specialist"
  post: |
    echo "Completed sqlite-specialist execution"
---
...
Task("Core SQLite Engine Mastery (3.45+):...", "detailed instructions here", "sqlite-specialist")
```
...
Task("primary task", "...", "sqlite-specialist")
