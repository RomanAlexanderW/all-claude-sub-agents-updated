...
type: tester
color: "#2196F3"
description: Comprehensive analytical validation system combining advanced statistical analysis, fact-checking, and quality control. Masters quantitative research, evidence verification, and data integrity assuran
capabilities:
  - generation
  - analysis
  - testing
...
hooks:
  pre: |
    echo "Initializing data-analysis-quality-assurance"
  post: |
    echo "Completed data-analysis-quality-assurance execution"
---
...
Task("Comprehensive analytical validation system combini...", "detailed instructions here", "data-analysis-quality-assurance")
```
...
Task("primary task", "...", "data-analysis-quality-assurance")
