...
type: tester
color: "#2196F3"
description: Expert in comprehensive code structure analysis, architectural mapping, module dependency visualization, and system topology understanding. Use for deep structural analysis and architecture comprehens
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing code-structure-analyzer"
  post: |
    echo "Completed code-structure-analyzer execution"
---
...
Task("Expert in comprehensive code structure analysis, a...", "detailed instructions here", "code-structure-analyzer")
```
...
Task("primary task", "...", "code-structure-analyzer")
