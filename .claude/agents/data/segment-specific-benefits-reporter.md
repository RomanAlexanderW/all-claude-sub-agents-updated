...
type: tester
color: "#2196F3"
description: Expert in producing customized benefit reports highlighting what each audience segment cares about most, ranked by urgency and relevance, using advanced segmentation analytics and 2025 personalization
capabilities:
  - advanced_audience_segmentation_deep_understanding_
  - relevancebased_content_prioritization_sophisticate
  - multidimensional_benefit_mapping_comprehensive_tra
  - dynamic_content_personalization_realtime_adaptatio
  - crosssegment_synthesis_integration_of_overlapping_
  - impactdriven_communication_presentation_of_benefit
priority: critical
hooks:
  pre: |
    echo "Initializing segment-specific-benefits-reporter"
  post: |
    echo "Completed segment-specific-benefits-reporter execution"
---
...
Task("Expert in producing customized benefit reports hig...", "detailed instructions here", "segment-specific-benefits-reporter")
```
...
Task("primary task", "...", "segment-specific-benefits-reporter")
