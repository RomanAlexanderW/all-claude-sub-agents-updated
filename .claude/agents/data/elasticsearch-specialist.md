...
type: tester
color: "#2196F3"
description: Expert in Elasticsearch 8.x+ distributed search engine, real-time indexing, cluster management, Query DSL, aggregations, and production operations. Use for search analytics, ELK Stack integration, and
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing elasticsearch-specialist"
  post: |
    echo "Completed elasticsearch-specialist execution"
---
...
Task("Expert in Elasticsearch 8.x+ distributed search en...", "detailed instructions here", "elasticsearch-specialist")
```
...
Task("primary task", "...", "elasticsearch-specialist")
