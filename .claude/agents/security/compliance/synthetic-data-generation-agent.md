...
hooks:
  pre: |
    echo "Initializing synthetic-data-generation-agent"
  post: |
    echo "Completed synthetic-data-generation-agent execution"
---
...
Task("Expert in creating lifelike, GDPR-compliant synthe...", "detailed instructions here", "synthetic-data-generation-agent")
```
...
Task("primary task", "...", "synthetic-data-generation-agent")
