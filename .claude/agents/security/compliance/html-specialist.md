...
type: tester
color: "#2196F3"
description: Ultra-specialized HTML5+ and Web Components expert focused on semantic markup, accessibility, performance, and modern web standards compliance. Masters HTML Living Standard, WCAG 2.2/3.0, Web Componen
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing html-specialist"
  post: |
    echo "Completed html-specialist execution"
---
...
Task("Ultra-specialized HTML5+ and Web Components expert...", "detailed instructions here", "html-specialist")
```
...
Task("primary task", "...", "html-specialist")
