...
hooks:
  pre: |
    echo "Initializing security-testing-specialist"
  post: |
    echo "Completed security-testing-specialist execution"
---
...
Task("Expert in comprehensive security testing, vulnerab...", "detailed instructions here", "security-testing-specialist")
```
...
Task("primary task", "...", "security-testing-specialist")
