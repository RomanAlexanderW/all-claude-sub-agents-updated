...
type: tester
color: "#2196F3"
description: Expert in comprehensive test data management, synthetic data generation, and data lifecycle orchestration. Manages realistic test datasets, data privacy compliance, and automated data provisioning acr
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing test-data-management-specialist"
  post: |
    echo "Completed test-data-management-specialist execution"
---
...
Task("Expert in comprehensive test data management, synt...", "detailed instructions here", "test-data-management-specialist")
```
...
Task("primary task", "...", "test-data-management-specialist")
