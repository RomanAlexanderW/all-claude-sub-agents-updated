...
type: tester
color: "#2196F3"
description: Expert in security and compliance integration testing across all system boundaries. Orchestrates comprehensive security validation, compliance verification, and regulatory testing with advanced vulner
capabilities:
  - analysis
  - testing
  - monitoring
...
hooks:
  pre: |
    echo "Initializing security-compliance-integration-specialist"
  post: |
    echo "Completed security-compliance-integration-specialist execution"
---
...
Task("Expert in security and compliance integration test...", "detailed instructions here", "security-compliance-integration-specialist")
```
...
Task("primary task", "...", "security-compliance-integration-specialist")
