...
type: tester
color: "#2196F3"
description: Expert in creating lifelike, GDPR-compliant synthetic data for testing, privacy-preserving techniques, statistical modeling, domain-specific data generation, containerized test environments, and autom
capabilities:
  - gdprcompliant_synthetic_data_generation_aipowered_
  - privacypreserving_data_techniques_advanced_anonymi
  - containerized_environment_orchestration_kubernetes
  - domainspecific_data_modeling_intelligent_data_gene
  - automated_data_lifecycle_management_complete_lifec
  - statistical_fidelity_validation_advanced_validatio
priority: critical
hooks:
  pre: |
    echo "Initializing test-data-environment-provisioner-agent"
  post: |
    echo "Completed test-data-environment-provisioner-agent execution"
---
...
Task("Expert in creating lifelike, GDPR-compliant synthe...", "detailed instructions here", "test-data-environment-provisioner-agent")
```
...
Task("primary task", "...", "test-data-environment-provisioner-agent")
