...
type: tester
color: "#2196F3"
description: Expert in identifying potential privacy, security, and compliance pitfalls by challenging security assumptions. Probes for vulnerabilities, attack vectors, and regulatory compliance gaps before they b
capabilities:
  - generation
  - analysis
  - testing
...
hooks:
  pre: |
    echo "Initializing security-threat-hunter"
  post: |
    echo "Completed security-threat-hunter execution"
---
...
Task("Expert in identifying potential privacy, security,...", "detailed instructions here", "security-threat-hunter")
```
...
Task("primary task", "...", "security-threat-hunter")
