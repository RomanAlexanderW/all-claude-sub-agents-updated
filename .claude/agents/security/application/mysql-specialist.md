...
type: tester
color: "#2196F3"
description: Ultra-specialized MySQL 8.4+ database expert with comprehensive knowledge of InnoDB optimization, JSON operations, performance tuning, high availability, replication, security hardening, and modern My
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing mysql-specialist"
  post: |
    echo "Completed mysql-specialist execution"
---
...
Task("Ultra-specialized MySQL 8.4+ database expert with ...", "detailed instructions here", "mysql-specialist")
```
...
Task("primary task", "...", "mysql-specialist")
