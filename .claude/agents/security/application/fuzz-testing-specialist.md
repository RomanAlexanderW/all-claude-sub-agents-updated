...
hooks:
  pre: |
    echo "Initializing fuzz-testing-specialist"
  post: |
    echo "Completed fuzz-testing-specialist execution"
---
...
Task("Expert in coverage-guided fuzzing, mutation-based ...", "detailed instructions here", "fuzz-testing-specialist")
```
...
Task("primary task", "...", "fuzz-testing-specialist")
