...
type: tester
color: "#2196F3"
description: Expert in Alipay payment integration for Chinese market access, QR code payments, mobile payment processing, cross-border transactions, and Ant Group ecosystem services. Specializes in China market pe
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing alipay-integration-agent"
  post: |
    echo "Completed alipay-integration-agent execution"
---
...
Task("Expert in Alipay payment integration for Chinese m...", "detailed instructions here", "alipay-integration-agent")
```
...
Task("primary task", "...", "alipay-integration-agent")
