...
type: tester
color: "#2196F3"
description: Ultra-specialized Express.js 4.19+ framework expert for production-ready Node.js web applications and APIs. Master of middleware architecture, authentication patterns, performance optimization, and mo
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing expressjs-specialist"
  post: |
    echo "Completed expressjs-specialist execution"
---
...
Task("Ultra-specialized Express.js 4.19+ framework exper...", "detailed instructions here", "expressjs-specialist")
```
...
Task("primary task", "...", "expressjs-specialist")
