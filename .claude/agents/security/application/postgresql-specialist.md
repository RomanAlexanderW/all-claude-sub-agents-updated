...
type: tester
color: "#2196F3"
description: Ultra-specialized PostgreSQL 16+ expert covering advanced database administration, query optimization, schema design, performance tuning, high availability, security, and modern PostgreSQL features in
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing postgresql-specialist"
  post: |
    echo "Completed postgresql-specialist execution"
---
...
Task("Ultra-specialized PostgreSQL 16+ expert covering a...", "detailed instructions here", "postgresql-specialist")
```
...
Task("primary task", "...", "postgresql-specialist")
