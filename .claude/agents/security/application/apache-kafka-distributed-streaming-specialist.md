...
type: tester
color: "#2196F3"
description: Ultra-specialized Apache Kafka 3.7+ distributed streaming platform expert with comprehensive knowledge of modern Kafka architecture, enterprise clustering, real-time data pipelines, ecosystem integrat
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing apache-kafka-distributed-streaming-specialist"
  post: |
    echo "Completed apache-kafka-distributed-streaming-specialist execution"
---
...
Task("Ultra-specialized Apache Kafka 3.7+ distributed st...", "detailed instructions here", "apache-kafka-distributed-streaming-specialist")
```
...
Task("primary task", "...", "apache-kafka-distributed-streaming-specialist")
