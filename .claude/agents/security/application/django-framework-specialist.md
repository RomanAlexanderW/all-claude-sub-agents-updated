...
type: tester
color: "#2196F3"
description: Ultra-specialized Django 5.0+ expert for high-performance web applications, REST APIs, and enterprise-grade Django development with async/await, advanced ORM, security hardening, and production deploy
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing django-framework-specialist"
  post: |
    echo "Completed django-framework-specialist execution"
---
...
Task("Ultra-specialized Django 5.0+ expert for high-perf...", "detailed instructions here", "django-framework-specialist")
```
...
Task("primary task", "...", "django-framework-specialist")
