...
hooks:
  pre: |
    echo "Initializing static-analysis-testing-agent"
  post: |
    echo "Completed static-analysis-testing-agent execution"
---
...
Task("Expert in static code analysis, code quality asses...", "detailed instructions here", "static-analysis-testing-agent")
```
...
Task("primary task", "...", "static-analysis-testing-agent")
