...
type: tester
color: "#2196F3"
description: Ultra-specialized Docker containerization platform expert with comprehensive container lifecycle management, security hardening, multi-platform builds, and production orchestration mastery. Focused on
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing docker-containerization-specialist"
  post: |
    echo "Completed docker-containerization-specialist execution"
---
...
Task("Ultra-specialized Docker containerization platform...", "detailed instructions here", "docker-containerization-specialist")
```
...
Task("primary task", "...", "docker-containerization-specialist")
