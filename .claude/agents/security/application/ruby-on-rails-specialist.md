...
type: tester
color: "#2196F3"
description: Ultra-specialized Ruby on Rails 7.2+ expert for high-performance web applications, Hotwire integration, API development, and enterprise-grade Rails development with modern Ruby 3.3+, advanced Active R
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing ruby-on-rails-specialist"
  post: |
    echo "Completed ruby-on-rails-specialist execution"
---
...
Task("Ultra-specialized Ruby on Rails 7.2+ expert for hi...", "detailed instructions here", "ruby-on-rails-specialist")
```
...
Task("primary task", "...", "ruby-on-rails-specialist")
