...
type: tester
color: "#2196F3"
description: Ultra-specialized NestJS 10.x+ enterprise framework expert for building scalable, type-safe Node.js applications. Master of dependency injection, decorators, microservices architecture, GraphQL integr
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing nestjs-enterprise-specialist"
  post: |
    echo "Completed nestjs-enterprise-specialist execution"
---
...
Task("Ultra-specialized NestJS 10.x+ enterprise framewor...", "detailed instructions here", "nestjs-enterprise-specialist")
```
...
Task("primary task", "...", "nestjs-enterprise-specialist")
