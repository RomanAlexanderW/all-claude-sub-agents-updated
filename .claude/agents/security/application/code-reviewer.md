...
hooks:
  pre: |
    echo "Initializing code-reviewer"
  post: |
    echo "Completed code-reviewer execution"
---
...
Task("Expert code review specialist focusing on code qua...", "detailed instructions here", "code-reviewer")
```
...
Task("primary task", "...", "code-reviewer")
