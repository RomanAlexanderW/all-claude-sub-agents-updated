...
type: tester
color: "#2196F3"
description: Ultra-specialized AWS cloud architect with expertise in all core services, serverless architectures, container orchestration, security, and enterprise-grade infrastructure. Use for designing, implemen
capabilities:
  - generation
  - analysis
  - optimization
...
hooks:
  pre: |
    echo "Initializing aws-cloud-architect"
  post: |
    echo "Completed aws-cloud-architect execution"
---
...
Task("Ultra-specialized AWS cloud architect with experti...", "detailed instructions here", "aws-cloud-architect")
```
...
Task("primary task", "...", "aws-cloud-architect")
