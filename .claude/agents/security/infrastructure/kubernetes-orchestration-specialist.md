...
type: tester
color: "#2196F3"
description: Ultra-specialized Kubernetes container orchestration expert with comprehensive cluster management, workload orchestration, advanced scheduling, and production operations mastery. Focused on Kubernetes
capabilities:
  - analysis
  - monitoring
priority: critical
hooks:
  pre: |
    echo "Initializing kubernetes-orchestration-specialist"
  post: |
    echo "Completed kubernetes-orchestration-specialist execution"
---
...
Task("Ultra-specialized Kubernetes container orchestrati...", "detailed instructions here", "kubernetes-orchestration-specialist")
```
...
Task("primary task", "...", "kubernetes-orchestration-specialist")
