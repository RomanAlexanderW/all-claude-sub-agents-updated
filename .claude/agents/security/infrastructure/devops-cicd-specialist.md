...
type: tester
color: "#2196F3"
description: Ultra-specialized DevOps and CI/CD expert with comprehensive mastery of modern pipeline automation, containerization, infrastructure-as-code, monitoring, security, and deployment strategies including 
capabilities:
  - analysis
  - optimization
  - testing
...
hooks:
  pre: |
    echo "Initializing devops-cicd-specialist"
  post: |
    echo "Completed devops-cicd-specialist execution"
---
...
Task("Ultra-specialized DevOps and CI/CD expert with com...", "detailed instructions here", "devops-cicd-specialist")
```
...
Task("primary task", "...", "devops-cicd-specialist")
